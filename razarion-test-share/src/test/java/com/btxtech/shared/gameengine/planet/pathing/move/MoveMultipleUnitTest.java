...
public class MoveMultipleUnitTest extends ScenarioBaseTest {
    ...
    public void move4East1() {
        testScenario(new Scenario("MoveMultipleUnitTest_move4East1.json", getClass()) {
            ...
            protected void createSyncItems() {
                ...
                createSyncBaseItemSimplePath(FallbackConfig.MOVING_TEST_ITEM_TYPE_ID, new DecimalPosition(44, 158), new DecimalPosition(100, 160));
                createSyncBaseItemSimplePath(FallbackConfig.MOVING_TEST_ITEM_TYPE_ID, new DecimalPosition(44, 162), new DecimalPosition(100, 160));
            }
        });
    }
    ...
    public void move6East1() {
        testScenario(new Scenario("MoveMultipleUnitTest_move6East1.json", getClass()) {
            ...
            protected void createSyncItems() {
                ...
                createSyncBaseItemSimplePath(FallbackConfig.MOVING_TEST_ITEM_TYPE_ID, new DecimalPosition(48, 158), new DecimalPosition(100, 160));
                createSyncBaseItemSimplePath(FallbackConfig.MOVING_TEST_ITEM_TYPE_ID, new DecimalPosition(48, 162), new DecimalPosition(100, 160));
            }
        });
    }
    ...
    public void  move25East1() {
        testScenario(new Scenario("MoveMultipleUnitTest_move25East1.json", getClass()) {
            @Override
            protected void createSyncItems() {
                createSyncBaseItemGroup(FallbackConfig.MOVING_TEST_ITEM_TYPE_ID, 5, new DecimalPosition(40, 160), new DecimalPosition(160, 160));
            }
        });
    }
}

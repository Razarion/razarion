...
public class ThreeMovingUnitsTest extends ScenarioBaseTest {
    ...
    public void parallel1() {
        testScenario(new Scenario("ThreeMovingUnitsTest_parallel1.json", getClass()) {
            ...
            protected void createSyncItems() {
                createSyncBaseItemSimplePath(FallbackConfig.MOVING_TEST_ITEM_TYPE_ID, new DecimalPosition(40.53, 160), new DecimalPosition(100, 160));
    ...
    public void frontal2() {
        testScenario(new Scenario("ThreeMovingUnitsTest_frontal2.json", getClass()) {
            @Override
            protected void createSyncItems() {
                createSyncBaseItemSimplePath(FallbackConfig.MOVING_TEST_ITEM_TYPE_ID, new DecimalPosition(100, 162), new DecimalPosition(40, 162));

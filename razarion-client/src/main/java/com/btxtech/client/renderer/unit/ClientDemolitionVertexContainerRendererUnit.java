...
public class ClientDemolitionVertexContainerRendererUnit extends AbstractDemolitionVertexContainerRenderUnit {
    ...
    @PostConstruct
    public void init() {
        webGlFacade.init(new WebGlFacadeConfig(this, Shaders.INSTANCE.demolitionVertexContainerVertexShader(), Shaders.INSTANCE.demolitionVertexContainerFragmentShader()).enableTransformation(true));

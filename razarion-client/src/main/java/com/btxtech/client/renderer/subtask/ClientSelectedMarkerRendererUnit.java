...
public class ClientSelectedMarkerRendererUnit extends AbstractSelectedMarkerRendererUnit {
    ...
    @Override
    public void init() {
        webGlFacade.init(new WebGlFacadeConfig(Shaders.SHADERS.commonVisibilityVertexShader(), Shaders.SHADERS.itemMarkerFragmentShader()).enableTransformation(false));

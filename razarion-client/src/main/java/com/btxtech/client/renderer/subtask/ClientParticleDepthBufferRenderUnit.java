...
public class ClientParticleDepthBufferRenderUnit extends AbstractParticleRenderUnit {
    ...
    @Override
    public void init() {
        webGlFacade.init(new WebGlFacadeConfig(Shaders.SHADERS.particleVertexShader(), Shaders.SHADERS.particleDeptBufferFragmentShader()).enableShadowTransformation());

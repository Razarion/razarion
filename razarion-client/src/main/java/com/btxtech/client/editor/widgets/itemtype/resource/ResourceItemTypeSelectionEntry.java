...
public class ResourceItemTypeSelectionEntry implements TakesValue<ResourceItemType>, IsElement {
    ...
    private ResourceItemTypeSelectionDialog resourceItemTypeSelectionDialog;
    ...
    public void onClick(ClickEvent event) {
        resourceItemTypeSelectionDialog.selectComponent(this);
    }
    ...
    public void setResourceItemTypeSelectionDialog(ResourceItemTypeSelectionDialog resourceItemTypeSelectionDialog) {
        this.resourceItemTypeSelectionDialog = resourceItemTypeSelectionDialog;
    }
}

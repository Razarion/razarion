...
public class SlopeConfigCrudSidebar extends AbstractCrudeParentSidebar<SlopeConfig_OLD, SlopeConfigPropertyPanel> {
    ...
    @Override
    protected CrudEditor<SlopeConfig_OLD> getCrudEditor() {

...
public class AbstractSyncPhysical {
    private final Logger logger = Logger.getLogger(AbstractSyncPhysical.class.getName());
    ...
    public AbstractSyncPhysical(SyncItemContainerServiceImpl syncItemContainerService) {
    ...
    public double getDistance(AbstractSyncPhysical abstractSyncPhysical) {
        return getDistance(abstractSyncPhysical.getPosition(), abstractSyncPhysical.getRadius());
    }
    ...
    public double getDistance(SyncItem other) {
        return getDistance(other.getAbstractSyncPhysical());
    }

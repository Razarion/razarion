...
public abstract class GameEngineWorker implements PlanetTickListener, QuestListener, GameLogicListener {
    ...
    protected void dispatch(GameEngineControlPackage controlPackage) {
        switch (controlPackage.getCommand()) {
            ...
            case COMMAND_FINALIZE_BUILD:
                ...
                break;
            case COMMAND_BUILD:
                commandService.build((int) controlPackage.getData(0), (DecimalPosition) controlPackage.getData(1), (int) controlPackage.getData(2), (DecimalPosition) controlPackage.getData(3));
                break;
            ...
            case COMMAND_CANCEL_FACTORY_QUEUE:
                commandService.cancelFactoryQueue((int) controlPackage.getData(0), (int) controlPackage.getData(1));
                break;
    ...
    private void sendBaseToClient(GameEngineControlPackage.Command cmd, PlayerBase playerBase) {
        ...
        playerBaseDto.setCreatedMillis(playerBase.getCreatedMillis());

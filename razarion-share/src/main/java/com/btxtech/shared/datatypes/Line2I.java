...
//        return new Line2I(new DecimalPosition(point1.startX(), point1.startY() - distance), new DecimalPosition(point2.startX(), point2.startY() - distance));
//    }
//
//    public Line2I shiftParallelE(double distance) {
//        return new Line2I(new DecimalPosition(point1.startX() + distance, point1.startY()), new DecimalPosition(point2.startX() + distance, point2.startY()));
//    }
//

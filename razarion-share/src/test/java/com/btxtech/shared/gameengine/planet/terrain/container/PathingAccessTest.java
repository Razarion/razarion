...
public class PathingAccessTest extends TerrainServiceTestBase {
    ...
    public void testGetPathingAccess() {
        ...
        Assert.assertEquals(new DecimalPosition(1, 6), pathingNodeWrapper.getNodeRelative());
        ...
        Assert.assertEquals(new DecimalPosition(2, 3), pathingNodeWrapper.getNodeRelative());
        ...
        Assert.assertEquals(new DecimalPosition(0, 0), pathingNodeWrapper.getNodeRelative());
    ...
    public void testSuccessorSubNode8North() {
        ...
        pathingNodeWrapper.provideNorthSuccessors(actual -> {
            ...
            nodeHandlerHelper.handleExpectedPosition(actual.getNodeRelative());
        });

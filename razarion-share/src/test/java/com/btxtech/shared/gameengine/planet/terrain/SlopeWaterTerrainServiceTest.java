...
import com.btxtech.shared.gameengine.datatypes.config.SlopeGroundSplattingConfig;
...
public class SlopeWaterTerrainServiceTest extends WeldTerrainServiceTestBase {
    ...
    public void generateTerrainThreeJs() {
        ...
        terrainObjectConfigs.add(new TerrainObjectConfig().setId(2).setInternalName("Rock 1").setShape3DId(4).setRadius(2));
        ...
        terrainObjectConfigs.add(new TerrainObjectConfig().setId(4).setInternalName("Rock 2").setShape3DId(5).setRadius(3));
        ...
        terrainObjectPositions.add(new TerrainObjectPosition().setId(24).setTerrainObjectId(4).setPosition(new DecimalPosition(304.854, 236.629)).setScale(1.1).setOffset(new Vertex(0, 0, 0)).setRotation(new Vertex(Math.toRadians(0), Math.toRadians(0), Math.toRadians(20))));
        terrainObjectPositions.add(new TerrainObjectPosition().setId(25).setTerrainObjectId(4).setPosition(new DecimalPosition(290.354, 216.629)).setScale(0.5).setOffset(new Vertex(0, 0, 0)).setRotation(new Vertex(Math.toRadians(0), Math.toRadians(0), Math.toRadians(60))));
        terrainObjectPositions.add(new TerrainObjectPosition().setId(23).setTerrainObjectId(4).setPosition(new DecimalPosition(311.604, 203.129)).setScale(1.4).setOffset(new Vertex(0, 0, 0)).setRotation(new Vertex(Math.toRadians(0), Math.toRadians(0), Math.toRadians(120))));
        terrainObjectPositions.add(new TerrainObjectPosition().setId(23).setTerrainObjectId(4).setPosition(new DecimalPosition(316, 169)).setScale(2).setOffset(new Vertex(0, 0, -5)).setRotation(new Vertex(Math.toRadians(0), Math.toRadians(0), Math.toRadians(220))));
        terrainObjectPositions.add(new TerrainObjectPosition().setId(23).setTerrainObjectId(4).setPosition(new DecimalPosition(282, 196)).setScale(2).setOffset(new Vertex(0, 0, -5)).setRotation(new Vertex(Math.toRadians(0), Math.toRadians(0), Math.toRadians(200))));
        terrainObjectPositions.add(new TerrainObjectPosition().setId(23).setTerrainObjectId(4).setPosition(new DecimalPosition(250.354, 155.629)).setScale(0.3).setOffset(new Vertex(0, 0, 0)).setRotation(new Vertex(Math.toRadians(0), Math.toRadians(0), Math.toRadians(280))));
        terrainObjectPositions.add(new TerrainObjectPosition().setId(23).setTerrainObjectId(4).setPosition(new DecimalPosition(253.854, 131.879)).setScale(1.1).setOffset(new Vertex(0, 0, 0)).setRotation(new Vertex(Math.toRadians(0), Math.toRadians(0), Math.toRadians(340))));
        terrainObjectPositions.add(new TerrainObjectPosition().setId(23).setTerrainObjectId(4).setPosition(new DecimalPosition(251.354, 102.629)).setScale(0.6).setOffset(new Vertex(0, 0, 0)).setRotation(new Vertex(Math.toRadians(0), Math.toRadians(0), Math.toRadians(180))));

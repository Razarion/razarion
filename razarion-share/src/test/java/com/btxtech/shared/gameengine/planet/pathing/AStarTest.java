...
public class AStarTest extends AStarBaseTest {
    ...
    public void land() {
        ...
        assertSimplePath(simplePath, 0, new DecimalPosition(60.0, 20.0), new DecimalPosition(58.0, 26.0), new DecimalPosition(54.0, 26.0), new DecimalPosition(50.0, 26.0), new DecimalPosition(44.0, 28.0), new DecimalPosition(36.0, 28.0), new DecimalPosition(36.0, 36.0), new DecimalPosition(36.0, 44.0), new DecimalPosition(36.0, 52.0), new DecimalPosition(36.0, 60.0), new DecimalPosition(36.0, 68.0), new DecimalPosition(36.0, 76.0), new DecimalPosition(36.0, 84.0), new DecimalPosition(36.0, 92.0), new DecimalPosition(36.0, 100.0), new DecimalPosition(36.0, 108.0), new DecimalPosition(34.0, 114.0), new DecimalPosition(34.0, 118.0), new DecimalPosition(34.0, 122.0), new DecimalPosition(34.0, 126.0), new DecimalPosition(34.0, 130.0), new DecimalPosition(34.0, 134.0), new DecimalPosition(36.0, 140.0), new DecimalPosition(44.0, 140.0), new DecimalPosition(52.0, 140.0), new DecimalPosition(60.0, 140.0), new DecimalPosition(62.0, 134.0), new DecimalPosition(62.0, 130.0), new DecimalPosition(62.0, 126.0), new DecimalPosition(68.0, 124.0), new DecimalPosition(76.0, 124.0), new DecimalPosition(84.0, 124.0), new DecimalPosition(92.0, 124.0), new DecimalPosition(100.0, 124.0), new DecimalPosition(108.0, 124.0), new DecimalPosition(110.0, 118.0), new DecimalPosition(116.0, 116.0), new DecimalPosition(116.0, 108.0), new DecimalPosition(118.0, 102.0), new DecimalPosition(122.0, 102.0), new DecimalPosition(126.0, 102.0), new DecimalPosition(130.0, 102.0), new DecimalPosition(134.0, 102.0), new DecimalPosition(138.0, 102.0), new DecimalPosition(142.0, 102.0), new DecimalPosition(146.0, 102.0), new DecimalPosition(150.0, 102.0), new DecimalPosition(154.0, 102.0), new DecimalPosition(158.0, 102.0), new DecimalPosition(162.0, 102.0), new DecimalPosition(166.0, 102.0), new DecimalPosition(170.0, 102.0), new DecimalPosition(174.0, 102.0), new DecimalPosition(178.0, 102.0), new DecimalPosition(182.0, 102.0), new DecimalPosition(188.0, 100.0), new DecimalPosition(188.0, 92.0), new DecimalPosition(188.0, 84.0), new DecimalPosition(182.0, 82.0), new DecimalPosition(178.0, 82.0), new DecimalPosition(178.0, 78.0), new DecimalPosition(172.0, 76.0), new DecimalPosition(164.0, 76.0), new DecimalPosition(156.0, 76.0), new DecimalPosition(148.0, 76.0), new DecimalPosition(140.0, 76.0), new DecimalPosition(132.0, 76.0), new DecimalPosition(124.0, 76.0), new DecimalPosition(116.0, 76.0), new DecimalPosition(111.5, 72.5), new DecimalPosition(110.5, 72.5), new DecimalPosition(110.5, 71.5), new DecimalPosition(109.0, 71.0), new DecimalPosition(106.0, 70.0), new DecimalPosition(100.0, 68.0), new DecimalPosition(100.0, 60.0), new DecimalPosition(98.0, 54.0), new DecimalPosition(92.0, 52.0), new DecimalPosition(84.0, 52.0), new DecimalPosition(76.0, 52.0), new DecimalPosition(64.0, 48.0));
    }
    ...
    public void landDestinationNearBlocked() {
        ...
        assertSimplePath(simplePath, 0, new DecimalPosition(108.0, 124.0), new DecimalPosition(100.0, 124.0), new DecimalPosition(92.0, 124.0), new DecimalPosition(84.0, 124.0), new DecimalPosition(77.0, 119.9));
    }

    @Test
    public void water() {
        SimplePath simplePath = setupPath(4, TerrainType.WATER, new DecimalPosition(207, 240), new DecimalPosition(192, 344));
        assertSimplePath(simplePath, 0, new DecimalPosition(204.0, 252.0), new DecimalPosition(196.0, 252.0), new DecimalPosition(188.0, 252.0), new DecimalPosition(180.0, 252.0), new DecimalPosition(172.0, 252.0), new DecimalPosition(164.0, 252.0), new DecimalPosition(164.0, 260.0), new DecimalPosition(162.0, 266.0), new DecimalPosition(162.0, 270.0), new DecimalPosition(164.0, 276.0), new DecimalPosition(164.0, 284.0), new DecimalPosition(170.0, 286.0), new DecimalPosition(172.0, 292.0), new DecimalPosition(178.0, 294.0), new DecimalPosition(180.0, 300.0), new DecimalPosition(186.0, 302.0), new DecimalPosition(188.0, 308.0), new DecimalPosition(188.0, 316.0), new DecimalPosition(188.0, 324.0), new DecimalPosition(188.0, 332.0), new DecimalPosition(188.0, 340.0), new DecimalPosition(196.0, 340.0), new DecimalPosition(192.0, 344.0));
    }

    @Test
    public void stuck() {
        SimplePath simplePath = setupPath(3, TerrainType.WATER, new DecimalPosition(178.5, 259.5), new DecimalPosition(180, 250));
        assertSimplePath(simplePath, 0, new DecimalPosition(178.5, 258.5), new DecimalPosition(179.0, 257.0), new DecimalPosition(180.0, 250.0));
    }
    ...
    public void landWater1() {
        ...
        assertSimplePath(simplePath, 0.0, new DecimalPosition(252.0, 244.0), new DecimalPosition(252.0, 236.0), new DecimalPosition(244.0, 236.0), new DecimalPosition(226.25, 238.5));
    }
    ...
    public void landWater2() {
        ...
        assertSimplePath(simplePath, 0.0, new DecimalPosition(260.0, 236.0), new DecimalPosition(260.0, 228.0), new DecimalPosition(252.0, 228.0), new DecimalPosition(252.0, 220.0), new DecimalPosition(244.0, 220.0), new DecimalPosition(244.0, 212.0), new DecimalPosition(244.0, 204.0), new DecimalPosition(244.0, 196.0), new DecimalPosition(244.0, 188.0), new DecimalPosition(238.0, 186.0), new DecimalPosition(234.0, 186.0), new DecimalPosition(230.0, 186.0), new DecimalPosition(226.0, 186.0), new DecimalPosition(222.0, 186.0), new DecimalPosition(218.0, 186.0), new DecimalPosition(214.0, 186.0), new DecimalPosition(213.25, 203.0));
    }
    ...
    public void landWater5() {
        ...
        assertSimplePath(simplePath, 0.0, new DecimalPosition(252.0, 244.0), new DecimalPosition(244.0, 244.0), new DecimalPosition(244.0, 252.0), new DecimalPosition(244.0, 260.0), new DecimalPosition(244.0, 268.0), new DecimalPosition(238.0, 270.0), new DecimalPosition(234.0, 270.0), new DecimalPosition(230.0, 270.0), new DecimalPosition(226.0, 270.0), new DecimalPosition(222.0, 270.0), new DecimalPosition(218.0, 270.0), new DecimalPosition(214.0, 270.0), new DecimalPosition(210.0, 270.0), new DecimalPosition(206.0, 270.0), new DecimalPosition(202.0, 270.0), new DecimalPosition(198.0, 270.0), new DecimalPosition(194.0, 270.0), new DecimalPosition(190.0, 270.0), new DecimalPosition(186.0, 270.0), new DecimalPosition(182.0, 270.0), new DecimalPosition(162.25, 265.0));
    }
    ...
    public void waterLand1() {
        ...
        assertSimplePath(simplePath, 0.0, new DecimalPosition(132.0, 244.0), new DecimalPosition(132.0, 236.0), new DecimalPosition(132.0, 228.0), new DecimalPosition(132.0, 220.0), new DecimalPosition(140.0, 220.0), new DecimalPosition(140.0, 212.0), new DecimalPosition(140.0, 204.0), new DecimalPosition(148.0, 204.0), new DecimalPosition(151.625, 186.0));
    }
    ...
    public void waterLand3() {
        ...
        assertSimplePath(simplePath, 0.0, new DecimalPosition(140.0, 252.0), new DecimalPosition(140.0, 260.0), new DecimalPosition(148.0, 260.0), new DecimalPosition(148.0, 268.0), new DecimalPosition(156.0, 268.0), new DecimalPosition(162.0, 270.0), new DecimalPosition(164.0, 276.0), new DecimalPosition(164.0, 284.0), new DecimalPosition(170.0, 282.0), new DecimalPosition(181.625, 269.5));
    }
    ...
    public void waterLand4() {
        ...
        assertSimplePath(simplePath, 0.0, new DecimalPosition(132.0, 260.0), new DecimalPosition(140.0, 260.0), new DecimalPosition(140.0, 268.0), new DecimalPosition(140.0, 276.0), new DecimalPosition(142.0, 282.0), new DecimalPosition(148.0, 284.0), new DecimalPosition(156.0, 284.0), new DecimalPosition(164.0, 284.0), new DecimalPosition(170.0, 286.0), new DecimalPosition(172.0, 292.0), new DecimalPosition(178.0, 294.0), new DecimalPosition(180.0, 300.0), new DecimalPosition(186.0, 302.0), new DecimalPosition(188.0, 308.0), new DecimalPosition(194.0, 310.0), new DecimalPosition(196.0, 316.0), new DecimalPosition(196.0, 324.0), new DecimalPosition(196.0, 332.0), new DecimalPosition(196.0, 340.0), new DecimalPosition(204.0, 340.0), new DecimalPosition(212.0, 340.0), new DecimalPosition(218.0, 342.0), new DecimalPosition(220.0, 348.0), new DecimalPosition(226.0, 350.0), new DecimalPosition(228.0, 356.0), new DecimalPosition(234.0, 358.0), new DecimalPosition(250.875, 365.0));
    }
    ...
    public void waterLand5() {
        ...
        assertSimplePath(simplePath, 0.0, new DecimalPosition(132.0, 260.0), new DecimalPosition(132.0, 268.0), new DecimalPosition(132.0, 276.0), new DecimalPosition(140.0, 276.0), new DecimalPosition(142.0, 282.0), new DecimalPosition(142.0, 286.0), new DecimalPosition(142.0, 290.0), new DecimalPosition(142.0, 294.0), new DecimalPosition(140.0, 300.0), new DecimalPosition(140.0, 308.0), new DecimalPosition(140.0, 316.0), new DecimalPosition(140.0, 324.0), new DecimalPosition(140.0, 332.0), new DecimalPosition(140.0, 340.0), new DecimalPosition(140.0, 348.0), new DecimalPosition(140.0, 356.0), new DecimalPosition(140.625, 374.25));
    }
    ...
    public void landWaterCoast1() {
        ...
        assertSimplePath(simplePath, 0.0, new DecimalPosition(140.0, 180.0), new DecimalPosition(138.0, 186.0), new DecimalPosition(134.0, 186.0), new DecimalPosition(133.625, 197.25));
    }
    ...
    public void landWaterCoast3() {
        ...
        assertSimplePath(simplePath, 0.0, new DecimalPosition(140.0, 180.0), new DecimalPosition(142.0, 186.0), new DecimalPosition(146.0, 186.0), new DecimalPosition(150.0, 186.0), new DecimalPosition(154.0, 186.0), new DecimalPosition(158.0, 186.0), new DecimalPosition(162.0, 186.0), new DecimalPosition(166.0, 186.0), new DecimalPosition(170.0, 186.0), new DecimalPosition(174.0, 186.0), new DecimalPosition(178.0, 186.0), new DecimalPosition(182.0, 186.0), new DecimalPosition(186.0, 186.0), new DecimalPosition(190.0, 186.0), new DecimalPosition(194.0, 186.0), new DecimalPosition(198.0, 186.0), new DecimalPosition(202.0, 186.0), new DecimalPosition(206.0, 186.0), new DecimalPosition(210.0, 186.0), new DecimalPosition(214.0, 186.0), new DecimalPosition(218.0, 186.0), new DecimalPosition(222.0, 186.0), new DecimalPosition(226.0, 186.0), new DecimalPosition(230.0, 186.0), new DecimalPosition(234.0, 186.0), new DecimalPosition(238.0, 186.0), new DecimalPosition(244.0, 188.0), new DecimalPosition(244.0, 196.0), new DecimalPosition(244.0, 204.0), new DecimalPosition(244.0, 212.0), new DecimalPosition(244.0, 220.0), new DecimalPosition(244.0, 228.0), new DecimalPosition(244.0, 236.0), new DecimalPosition(244.0, 244.0), new DecimalPosition(244.0, 252.0), new DecimalPosition(244.0, 260.0), new DecimalPosition(244.0, 268.0), new DecimalPosition(238.0, 270.0), new DecimalPosition(234.0, 270.0), new DecimalPosition(230.0, 270.0), new DecimalPosition(226.0, 270.0), new DecimalPosition(222.0, 270.0), new DecimalPosition(218.0, 270.0), new DecimalPosition(214.0, 270.0), new DecimalPosition(210.0, 270.0), new DecimalPosition(206.0, 270.0), new DecimalPosition(202.0, 270.0), new DecimalPosition(198.0, 270.0), new DecimalPosition(194.0, 270.0), new DecimalPosition(190.0, 270.0), new DecimalPosition(186.0, 270.0), new DecimalPosition(182.0, 270.0), new DecimalPosition(169.375, 263.75));
    }
    ...
    public void landWaterCoast4() {
        ...
        assertSimplePath(simplePath, 0.0, new DecimalPosition(140.0, 180.0), new DecimalPosition(142.0, 186.0), new DecimalPosition(146.0, 186.0), new DecimalPosition(150.0, 186.0), new DecimalPosition(154.0, 186.0), new DecimalPosition(158.0, 186.0), new DecimalPosition(162.0, 186.0), new DecimalPosition(166.0, 186.0), new DecimalPosition(170.0, 186.0), new DecimalPosition(174.0, 186.0), new DecimalPosition(178.0, 186.0), new DecimalPosition(182.0, 186.0), new DecimalPosition(186.0, 186.0), new DecimalPosition(190.0, 186.0), new DecimalPosition(194.0, 186.0), new DecimalPosition(198.0, 186.0), new DecimalPosition(202.0, 186.0), new DecimalPosition(206.0, 186.0), new DecimalPosition(210.0, 186.0), new DecimalPosition(214.0, 186.0), new DecimalPosition(218.0, 186.0), new DecimalPosition(222.0, 186.0), new DecimalPosition(226.0, 186.0), new DecimalPosition(230.0, 186.0), new DecimalPosition(234.0, 186.0), new DecimalPosition(238.0, 186.0), new DecimalPosition(244.0, 188.0), new DecimalPosition(244.0, 196.0), new DecimalPosition(244.0, 204.0), new DecimalPosition(244.0, 212.0), new DecimalPosition(244.0, 220.0), new DecimalPosition(244.0, 228.0), new DecimalPosition(244.0, 236.0), new DecimalPosition(244.0, 244.0), new DecimalPosition(244.0, 252.0), new DecimalPosition(244.0, 260.0), new DecimalPosition(244.0, 268.0), new DecimalPosition(244.0, 276.0), new DecimalPosition(244.0, 284.0), new DecimalPosition(244.0, 292.0), new DecimalPosition(244.0, 300.0), new DecimalPosition(244.0, 308.0), new DecimalPosition(244.0, 316.0), new DecimalPosition(244.0, 324.0), new DecimalPosition(244.0, 332.0), new DecimalPosition(244.0, 340.0), new DecimalPosition(246.0, 346.0), new DecimalPosition(252.0, 348.0), new DecimalPosition(252.0, 356.0), new DecimalPosition(252.0, 364.0), new DecimalPosition(252.0, 372.0), new DecimalPosition(244.0, 372.0), new DecimalPosition(236.0, 372.0), new DecimalPosition(228.0, 372.0), new DecimalPosition(220.0, 372.0), new DecimalPosition(212.0, 372.0), new DecimalPosition(204.0, 372.0), new DecimalPosition(196.0, 372.0), new DecimalPosition(194.125, 362.25));
    }
    ...
    protected void assertSimplePath(SimplePath actual, double expectedTotalRange, DecimalPosition... expectedPosition) {
        Assert.assertEquals("totalRange", expectedTotalRange, actual.getTotalRange(), 0.001);
        // showDisplay(actual, new PositionMarker().setLine(Arrays.asList(expectedPosition)));
        // printSimplePath(simplePath);
        TestHelper.assertDecimalPositions(Arrays.asList(expectedPosition), actual.getWayPositions());
    }

    private SimplePath setupPath(double radius, TerrainType land, DecimalPosition start, DecimalPosition destination) {
    ...
    private SimplePath setupPath(double actorRadius, TerrainType actorTerrainType, DecimalPosition actorPosition, double range, double targetRadius, TerrainType targetTerrainType, DecimalPosition targetPosition) {

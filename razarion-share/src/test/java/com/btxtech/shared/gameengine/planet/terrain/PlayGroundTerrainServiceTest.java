...
public class PlayGroundTerrainServiceTest extends DaggerTerrainServiceTestBase {
    ...
    private void setup(List<TerrainSlopePosition> terrainSlopePositions) {
        ...
        setupTerrainTypeService(null, slopeConfigs, null, waterConfigs, terrainObjectConfigs, planetConfig, terrainSlopePositions, null, null, null, null, null);
    }

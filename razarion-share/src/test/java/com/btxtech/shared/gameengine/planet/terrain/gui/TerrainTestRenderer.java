...
public class TerrainTestRenderer {
    List<DecimalPosition> polygon1 = Arrays.asList(new DecimalPosition(160.58984669545748, 320.73274777697014), new DecimalPosition(159.20400705505236, 314.7201496590594), new DecimalPosition(160.34870767554358, 308.6269498523199));
    List<DecimalPosition> polygon2 = Arrays.asList(new DecimalPosition(234.38760424003507, 86.95068100260762), new DecimalPosition(229.17831391443627, 83.58279213226079), new DecimalPosition(223.4512023103252, 82.86516231242993), new DecimalPosition(218.37903135547973, 80.28213462730551), new DecimalPosition(210.88446410654316, 77.63441132086871), new DecimalPosition(208.0481261389225, 76.15029269998104), new DecimalPosition(205.13127871295106, 75.73968922821793), new DecimalPosition(202.37411594710184, 74.27863889846614), new DecimalPosition(197.9214698848437, 73.62547744117593), new DecimalPosition(193.16077509790924, 71.48160097950448), new DecimalPosition(187.81711917547466, 70.64702129874757));
    // private static List<DecimalPosition> breakingLine1 = Arrays.asList(new DecimalPosition(151.5791764537405, 323.51025766525436), new DecimalPosition(150.2053704133815, 314.8767976439756), new DecimalPosition(151.39211712067228, 306.1922667916478), new DecimalPosition(160.0769634207341, 308.5530812155919), new DecimalPosition(159.20400705505236, 314.7201496590594), new DecimalPosition(160.1798460539216, 320.85912914544997));
    // private static List<DecimalPosition> breakingLine2 = Arrays.asList(new DecimalPosition(229.7228102503087, 93.74624780631167), new DecimalPosition(224.49974351670176, 91.27115860593008), new DecimalPosition(219.14345505354436, 90.76727048504421), new DecimalPosition(214.4829884470212, 88.39513959805771), new DecimalPosition(207.58040764602342, 86.00598291201561), new DecimalPosition(204.9864896862379, 84.61352980120847), new DecimalPosition(202.2925133746176, 84.28026364413847), new DecimalPosition(199.7742062715855, 82.89492984522256), new DecimalPosition(195.67247318088786, 82.33994895846232), new DecimalPosition(191.31824607468727, 80.29097591752276), new DecimalPosition(186.40585283394591, 79.5373352892959), new DecimalPosition(187.8168635135957, 70.64863184830327), new DecimalPosition(193.16077509790924, 71.48160097950448), new DecimalPosition(197.9214698848437, 73.62547744117593), new DecimalPosition(202.37411594710184, 74.27863889846614), new DecimalPosition(205.13127871295106, 75.73968922821793), new DecimalPosition(208.0481261389225, 76.15029269998104), new DecimalPosition(210.88446410654316, 77.63441132086871), new DecimalPosition(218.37903135547973, 80.28213462730551), new DecimalPosition(223.4512023103252, 82.86516231242993), new DecimalPosition(229.17831391443627, 83.58279213226079), new DecimalPosition(234.81626095651043, 86.32622355409435));
    private static final double LINE_WIDTH = 0.01;
...
//        drawTriangleContainer();
        ...
        // strokeLine(breakingLine1, 0.05, Color.AQUA, true);
        // strokeLine(breakingLine2, 0.05, Color.AQUA, true);
        strokeLine(polygon1, 0.05, Color.PINK, true);
        strokeLine(polygon2, 0.05, Color.PINK, true);

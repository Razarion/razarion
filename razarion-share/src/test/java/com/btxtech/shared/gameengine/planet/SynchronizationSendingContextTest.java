...
public class SynchronizationSendingContextTest {
    ...
    @Test
    public void test1() {
        SyncBaseItem syncBaseItem1 = GameTestHelper.createMockSyncBaseItem(1, 2, TerrainType.LAND, new DecimalPosition(10, 10));
        SyncBaseItem syncBaseItem2 = GameTestHelper.createMockSyncBaseItem(2, 2, TerrainType.LAND, new DecimalPosition(10, 20));
        SyncBaseItem syncBaseItem3 = GameTestHelper.createMockSyncBaseItem(3, 2, TerrainType.LAND, new DecimalPosition(10, 30));
        // Case 1
    ...
    public void test2() {
        ...
        SyncBaseItem syncBaseItem2 = GameTestHelper.createMockSyncBaseItem(2, 2, TerrainType.LAND, new DecimalPosition(10, 20));
        SyncBaseItem syncBaseItem3 = GameTestHelper.createMockSyncBaseItem(3, 2, TerrainType.LAND, new DecimalPosition(10, 30));
        SyncBaseItem syncBaseItem4 = GameTestHelper.createMockSyncBaseItem(4, 2, TerrainType.LAND, new DecimalPosition(10, 40));
        SyncBaseItem syncBaseItem5 = GameTestHelper.createMockSyncBaseItem(5, 2, TerrainType.LAND, new DecimalPosition(10, 50));

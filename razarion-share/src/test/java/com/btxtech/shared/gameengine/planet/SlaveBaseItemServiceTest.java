...
public class SlaveBaseItemServiceTest extends BaseItemServiceBase {
    ...
    public void test() {
        ...
        SyncBaseItemInfo attackerInfo = new SyncBaseItemInfo().setId(203).setBaseId(40).setItemTypeId(GameTestContent.ATTACKER_ITEM_TYPE_ID).setSyncPhysicalAreaInfo(syncPhysicalAreaInfo).setBuildup(1.0).setHealth(0.99).setSpawnProgress(1.0);
        ...
        SyncBaseItemInfo builderInfo = new SyncBaseItemInfo().setId(15).setBaseId(99).setItemTypeId(GameTestContent.BUILDER_ITEM_TYPE_ID).setSyncPhysicalAreaInfo(syncPhysicalAreaInfo).setBuildup(1.0).setHealth(0.34).setSpawnProgress(0.5);
        builderInfo.setToBeBuiltTypeId(GameTestContent.FACTORY_ITEM_TYPE_ID).setToBeBuildPosition(new DecimalPosition(200, 200));
        ...
        SyncBaseItemInfo factoryInfo = new SyncBaseItemInfo().setId(107).setBaseId(99).setItemTypeId(GameTestContent.FACTORY_ITEM_TYPE_ID).setSyncPhysicalAreaInfo(syncPhysicalAreaInfo).setBuildup(1.0).setHealth(0.5).setSpawnProgress(0.0);
        factoryInfo.setFactoryBuildupProgress(0.45).setToBeBuiltTypeId(GameTestContent.BUILDER_ITEM_TYPE_ID).setRallyPoint(new DecimalPosition(300, 150));
        ...
        Assert.assertEquals(GameTestContent.BUILDER_ITEM_TYPE_ID, builder.getBaseItemType().getId());
        ...
        Assert.assertEquals(GameTestContent.BUILDER_ITEM_TYPE_ID, ((BaseItemType) SimpleTestEnvironment.readField("toBeBuiltType", factory.getSyncFactory())).getId());
        ...
        Assert.assertEquals(GameTestContent.ATTACKER_ITEM_TYPE_ID, attacker.getBaseItemType().getId());

...
//    private static final DecimalPosition POINT_TRIANGLE_3 = new DecimalPosition(30, 20);
    ...
    public void sameDirection1() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 20), new DecimalPosition(10, 0));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(30, 20), new DecimalPosition(10, 0)));

        runTest(protagonist, physicalAreas, new DecimalPosition(10, 0));
    }

    @Test
    public void sameDirection2() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(30, 20), new DecimalPosition(10, 0));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 20), new DecimalPosition(10, 0)));
    ...
    public void sameDirection3() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 20), new DecimalPosition(10, 0));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(24, 20), new DecimalPosition(10, 0)));
    ...
    public void sameTarget1() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 20), new DecimalPosition(10, -5).normalize(10));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 16), new DecimalPosition(10, 5).normalize(10)));
    ...
    public void against1() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(30, 20), new DecimalPosition(10, 0));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(40, 20), new DecimalPosition(-10, 0)));

        runTest(protagonist, physicalAreas, new DecimalPosition(9.165, -4.000));
    }

    @Test
    public void cutOff1() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(18, 20), new DecimalPosition(10, 0));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 23.5), new DecimalPosition(10, -5).normalize(10)));
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 16.5), new DecimalPosition(10, 5).normalize(10)));

        runTest(protagonist, physicalAreas, new DecimalPosition(6.491, 0));
    }

    @Test
    public void cutOff2() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(22.53334828640062, 20.0), new DecimalPosition(16.914085744083103, 0.0));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(24.15842424362614, 16.0757879718212), new DecimalPosition(16.958178115101212, 1.1917193530786572)));
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(24.15842424362614, 23.9242120281788), new DecimalPosition(16.958178115101212, -1.1917193530786572)));
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20.0666779111833, 24.17954732809343), new DecimalPosition(16.958812996787714, -1.1826503033374522)));

        runTest(protagonist, physicalAreas, new DecimalPosition(16.268, 0));
    }

    @Test
    public void cutOff3() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 20), new DecimalPosition(10, 0).normalize(10));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 24), new DecimalPosition(30, -5).normalize(10)));
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 16), new DecimalPosition(30, 5).normalize(10)));
    ...
    public void against2Middle() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 20), new DecimalPosition(10, 0));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(40, 18), new DecimalPosition(-10, 0)));
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(40, 22), new DecimalPosition(-10, 0)));
    ...
    public void against2Above() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(30, 22.5), new DecimalPosition(10, 0));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(40, 18), new DecimalPosition(-10, 0)));
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(40, 22), new DecimalPosition(-10, 0)));

        runTest(protagonist, physicalAreas, new DecimalPosition(9.355, 3.532));
    }

    @Test
    public void against2AboveFail() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(30, 22), new DecimalPosition(10, 0));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(40, 18), new DecimalPosition(-10, 0)));
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(40, 22), new DecimalPosition(-10, 0)));
    ...
    public void against2HoleMiddle() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 20), new DecimalPosition(10, 0));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(40, 24), new DecimalPosition(-10, 0)));
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(40, 16), new DecimalPosition(-10, 0)));
    ...
    public void against2HoleAbove() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(30, 23.5), new DecimalPosition(10, 0));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(40, 24), new DecimalPosition(-10, 0)));
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(40, 16), new DecimalPosition(-10, 0)));

        runTest(protagonist, physicalAreas, new DecimalPosition(9.27, -3.5));
    }

    @Test
    public void overlap1() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(23.25, 18.3), new DecimalPosition(10, 0));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 20), new DecimalPosition(10, 0)));

        runTest(protagonist, physicalAreas, new DecimalPosition(9.978, -0.670));
    }
    ...
    public void overlap2() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 20), new DecimalPosition(10, 0));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(23.25, 18.3), new DecimalPosition(10, 0)));

        runTest(protagonist, physicalAreas, new DecimalPosition(9.596, 2.812));
    }

    @Test
    public void overlap3() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(22.5, 20.0), new DecimalPosition(10, 0));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 20), new DecimalPosition(10, 0)));

        runTest(protagonist, physicalAreas, new DecimalPosition(10.0, 0.0));
    }

    @Test
    public void overlap4() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(19.045454545454547, 20.09090909090909), new DecimalPosition(10, 0));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(22.5, 20.0), new DecimalPosition(10, 0)));

        runTest(protagonist, physicalAreas, new DecimalPosition(7.453, 6.667));
    }

    @Test
    public void overlap5() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 23), new DecimalPosition(10, 0));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 20), new DecimalPosition(10, 0)));

        runTest(protagonist, physicalAreas, new DecimalPosition(8.944, 4.472));
    }

    @Test
    public void overlap6() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(21, 20), new DecimalPosition(10, 0));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 17), new DecimalPosition(10, 0)));
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 23), new DecimalPosition(10, 0)));
    ...
    public void overlap7() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(19, 20), new DecimalPosition(10, 0));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 17), new DecimalPosition(10, 0)));
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 23), new DecimalPosition(10, 0)));
    ...
    public void overlap8() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 20), new DecimalPosition(10, 0));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 16.1), new DecimalPosition(10, 0)));
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20, 23.9), new DecimalPosition(10, 0)));
    ...
    public void unknown1() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(19.300187279685865, 23.7697593332751), new DecimalPosition(7.7869654150622845, -0.26517646985986776));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(17.9, 20.0), new DecimalPosition(6.5, 0.0)));
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(17.636898286437166, 27.56109120396766), new DecimalPosition(8.979692233285652, -0.6042577227221333)));
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(21.9, 20.0), new DecimalPosition(6.5, 0.0)));

        runTest(protagonist, physicalAreas, new DecimalPosition(7.787, -0.266));
    }

    @Test
    public void unknown2() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(17.89750480592674, 23.86212621643338), new DecimalPosition(6.496145932359411, -0.22380354217547135));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(16.79173066808286, 27.68886128334947), new DecimalPosition(8.480463023661791, -0.5759747427666616)));
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(15.8, 20.0), new DecimalPosition(4.5, 0.0)));
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20.25, 20.0), new DecimalPosition(5.0, 0.0)));

        runTest(protagonist, physicalAreas, new DecimalPosition(6.496, -0.224));
    }

    @Test
    public void ignorePusherFromBehind() {
        SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(20.5476892279602, 23.85557052271858), new DecimalPosition(6.99635651438783, -0.2258218846413296));
        List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(19.140697624168546, 27.64447114848093), new DecimalPosition(8.61542501685567, -0.5449342059616612)));
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(16.340678708083146, 23.86980196862154), new DecimalPosition(6.806872705033804, -0.21301466900269897)));
        physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(22.75, 20.0), new DecimalPosition(5.5, 0.0)));

        runTest(protagonist, physicalAreas, new DecimalPosition(5.168, -0.953));
    }

    private void runTest(SyncPhysicalMovable protagonist, List<SyncPhysicalArea> physicalAreas, DecimalPosition expected) {
    ...
    public void testGui() {
        TestGuiDisplay.show(new AbstractTestGuiRenderer() {
            ...
            protected void doRender() {
                DecimalPosition vAndPreferred = new DecimalPosition(10, 0);
                System.out.println("position: " + position);
                SyncPhysicalMovable protagonist = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, position, vAndPreferred);
                List<SyncPhysicalArea> physicalAreas = new ArrayList<>();
                physicalAreas.add(GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(22.5, 20.0), new DecimalPosition(10, 0)));
...
//                obstacles.add(GameTestHelper.createObstacleSlope(new DecimalPosition(105.278024733339, 104.042797975819), new DecimalPosition(106.1484457143097, 101.3639176522738), new DecimalPosition(0.30901699437486163, -0.9510565162951816), true, new DecimalPosition(0.3090169943749839, -0.9510565162951417), true, new DecimalPosition(0.9510565162951563, 0.30901699437493946)));
                // ------------- Generated code ends -------------
                Orca orca = new Orca(protagonist);
                ObstacleSlope.sortObstacleSlope(protagonist.getPosition2d(), obstacles);
                int size = Math.min(obstacles.size(), 10);
                ...
                strokeSyncPhysicalMovable(protagonist, 0.2, Color.RED);

                physicalAreas.forEach(syncPhysicalArea -> {
                    if (syncPhysicalArea instanceof SyncPhysicalMovable) {
                        ...
                        strokeSyncPhysicalMovable(syncPhysicalMovable, 0.2, Color.GRAY);
                        if (syncPhysicalMovable.getPreferredVelocity() != null && !syncPhysicalMovable.getPreferredVelocity().equalsDeltaZero()) {
                            strokeLine(new Line(syncPhysicalMovable.getPosition2d(), syncPhysicalMovable.getPosition2d().add(syncPhysicalMovable.getPreferredVelocity())), 0.2, Color.DARKBLUE);
                        }
                    } else {
                        strokeSyncPhysicalArea(syncPhysicalArea, 0.2, Color.GRAY);
                    }
                });
                ...
                if (!orca.getNewVelocity().equalsDeltaZero()) {
                    ...
                    System.out.println("New Speed: " + orca.getNewVelocity().magnitude() + " New Velocity: " + orca.getNewVelocity());
                }
    ...
    public void testSlope1() {
        SyncPhysicalMovable syncPhysicalMovable = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(40, 40), new DecimalPosition(10, 10));
    ...
    public void testSlope3() {
        ...
        SyncPhysicalMovable syncPhysicalMovable = GameTestHelper.createSyncPhysicalMovable(2.0, TerrainType.LAND, new DecimalPosition(17, 20), vAndPreferred);
        Orca orca = new Orca(syncPhysicalMovable);
    ...
    private void display(Orca orca, SyncPhysicalMovable protagonist, List<ObstacleSlope> obstacles, List<? extends SyncPhysicalArea> physicalAreas) {
        TestGuiDisplay.show(new AbstractTestGuiRenderer() {
            @Override
            protected void doRender() {
                if (obstacles != null) {

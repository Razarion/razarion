 ...
 */
@ColorBufferRenderer
public class DevToolStartPointRendererUnit extends AbstractStartPointRendererUnit implements VertexShader {
    @Inject
    ...
    protected void draw(ModelMatrices modelMatrices, Color color) {
        webGlProgramEmulator.setPaint(new javafx.scene.paint.Color(color.getR(), color.getG(), color.getB(), color.getA()));

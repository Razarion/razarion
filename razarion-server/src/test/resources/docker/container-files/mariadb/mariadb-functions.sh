...
function create_razarion() {
 mysql -uroot -e "CREATE DATABASE razarion"
 mysql -uroot -e "CREATE USER 'RazSys'@'127.0.0.1' IDENTIFIED BY 'dockerDb'";
 mysql -uroot -e "GRANT ALL PRIVILEGES ON razarion.* TO 'RazSys'@'127.0.0.1'";
}

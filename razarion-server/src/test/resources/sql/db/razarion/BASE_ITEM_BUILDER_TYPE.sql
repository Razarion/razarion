...
INSERT INTO `BASE_ITEM_BUILDER_TYPE` (`id`, `animationOriginX`, `animationOriginY`, `animationOriginZ`, `buildRange`, `progress`, `animationShape3d_id`, `animationParticle_id`) VALUES
	(1, 1.63196, 0, 3.04829, 10, 1, NULL, 6),
	(2, 1.63196, 0, 3.04829, 10, 1, NULL, 6);

...
CREATE TABLE IF NOT EXISTS `RESOURCE_ITEM_TYPE` (
  ...
  KEY `FKoka6r54glrgab0cua9tw5igwp` (`threeJsModelPackConfigEntity_id`),
  ...
  CONSTRAINT `FKoka6r54glrgab0cua9tw5igwp` FOREIGN KEY (`threeJsModelPackConfigEntity_id`) REFERENCES `THREE_JS_MODEL_PACK` (`id`),

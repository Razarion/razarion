...
public class ServerLevelQuestServiceTest extends ServerArquillianBaseTest {
    ...
    public void onQuestPassedUnregistered() throws Exception {
        ...
        systemConnection.getWebsocketMessageHelper().assertMessageSent(5, "LEVEL_UPDATE_SERVER", LevelUpPacket.class, new LevelUpPacket().setUserContext(expectedUserContext).setLevelUnlockConfigs(expectedLevelUnlockConfigs));

...
public class SceneEditorPersistenceTest extends ArquillianBaseTest {
    ...
    public void saveAllScenes() throws Exception {
        ...
        sceneConfigs.add(new SceneConfig().setViewFieldConfig(new ViewFieldConfig().setFromPosition(new DecimalPosition(12.4,54.23)).setToPosition(new DecimalPosition(17.9,100)).setBottomWidth(65.23).setCameraLocked(true).setSpeed(50.34)));

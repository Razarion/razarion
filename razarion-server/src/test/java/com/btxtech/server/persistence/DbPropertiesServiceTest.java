...
public class DbPropertiesServiceTest extends ArquillianBaseTest {
    ...
    public void crud() throws Exception {
        ...
        Assert.assertNull(dbPropertiesService.getImageIdProperty(DbPropertyKey.TIP_SPLASH_SCROLL_IMAGE));
        ...
        dbPropertiesService.setImageIdProperty(image1.getId(), DbPropertyKey.TIP_SPLASH_SCROLL_IMAGE);
        Assert.assertEquals(image1.getId(), dbPropertiesService.getImageIdProperty(DbPropertyKey.TIP_SPLASH_SCROLL_IMAGE));
        dbPropertiesService.setImageIdProperty(image2.getId(), DbPropertyKey.TIP_SPLASH_SCROLL_IMAGE);
        Assert.assertEquals(image2.getId(), dbPropertiesService.getImageIdProperty(DbPropertyKey.TIP_SPLASH_SCROLL_IMAGE));
        dbPropertiesService.setImageIdProperty(null, DbPropertyKey.TIP_SPLASH_SCROLL_IMAGE);
        Assert.assertNull(dbPropertiesService.getImageIdProperty(DbPropertyKey.TIP_SPLASH_SCROLL_IMAGE));

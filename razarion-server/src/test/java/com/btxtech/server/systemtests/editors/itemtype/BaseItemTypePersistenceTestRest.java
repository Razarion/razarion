...
public class BaseItemTypePersistenceTestRest extends AbstractSystemTest {
    ...
    private void finalizeAttacker(BaseItemType attacker) {
        ...
        attacker.setWeaponType(new WeaponType().range(10).damage(1).reloadTime(3).detonationRadius(1).projectileSpeed(17.0).projectileShape3DId(SHAPE_3D_1_ID).muzzleFlashParticleSystemConfigId(1111119999).turretType(new TurretType().setAngleVelocity(Math.toRadians(120)).setTurretCenter(new Vertex(-0.25, 0, 2)).setMuzzlePosition(new Vertex(1.3, 0, 0)).setShape3dMaterialId("Turret-material")));
    ...
    private void finalizeTower(BaseItemType tower) {
        ...
        tower.setWeaponType(new WeaponType().range(20).damage(1).reloadTime(3).detonationRadius(1).projectileSpeed(40.0).projectileShape3DId(SHAPE_3D_2_ID).muzzleFlashParticleSystemConfigId(1111119999).turretType(new TurretType().setAngleVelocity(Math.toRadians(120)).setTurretCenter(new Vertex(0, 0, 0.98)).setMuzzlePosition(new Vertex(5.2, 0, 5.4)).setShape3dMaterialId("turret_001-material")));

...
public class GroundEditorControllerTest extends AbstractCrudTest<GroundEditorController, GroundConfig> {
    ...
    protected void setupUpdate() {
        ...
        registerUpdate(groundConfig -> groundConfig.setSplatting(new GroundSplattingConfig().scale2(20.2).textureId(IMAGE_1_ID).scale1(100.0).scale2(30).blur(0.5).offset(13.8)));

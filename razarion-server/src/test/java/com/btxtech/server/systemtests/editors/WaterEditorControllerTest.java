...
public class WaterEditorControllerTest extends AbstractCrudTest<WaterEditorController, WaterConfig> {
    ...
    protected void setupUpdate() {
        registerUpdate(waterConfig -> waterConfig.waterLevel(0.9).groundLevel(-5).transparency(0.8).normalMapDepth(0.45).normalMapDepth(21).distortionStrength(2.3).distortionAnimationSeconds(12));
        registerUpdate(waterConfig -> waterConfig.shininess(3.1).specularStrength(12));

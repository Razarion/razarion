...
/**
 * Camera framing override for an item's thumbnail render. Lives in
 * razarion-server (not razarion-share) on purpose — the game engine and the
 * runtime client don't need this data, only the studio editor flow does.
 *
 * Persisted in BASE_ITEM_TYPE via ThumbnailCameraEmbeddable.
 */
public class BaseItemTypeThumbnailConfig {
    ...
    public int getBaseItemTypeId() { return baseItemTypeId; }
    public void setBaseItemTypeId(int baseItemTypeId) { this.baseItemTypeId = baseItemTypeId; }

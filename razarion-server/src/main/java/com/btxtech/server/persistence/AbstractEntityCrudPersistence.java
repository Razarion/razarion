...
public abstract class AbstractEntityCrudPersistence<E extends BaseEntity, ID extends Integer> {
    private final Class<E> entityClass;

    @Deprecated
    public AbstractEntityCrudPersistence(Class<E> entityClass, Object id, Object internalName) {
        this.entityClass = entityClass;
    }

    @Deprecated
    public AbstractEntityCrudPersistence(Class<E> entityClass) {
        this.entityClass = entityClass;
    }

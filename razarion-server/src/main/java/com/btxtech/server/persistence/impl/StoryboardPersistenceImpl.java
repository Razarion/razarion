...
public class StoryboardPersistenceImpl implements StoryboardPersistence {
    ...
    private void finalizeBulldozer(BaseItemType baseItemType) {
        ...
        baseItemType.setBuilderType(new BuilderType().setProgress(1).setRange(10).setAbleToBuild(Collections.singletonList(BASE_ITEM_TYPE_FACTORY)).setAnimationShape3dId(180831).setAnimationOrigin(new Vertex(2.3051, 0, 1.7)));

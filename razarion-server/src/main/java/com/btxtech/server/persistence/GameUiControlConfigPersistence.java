...
public class GameUiControlConfigPersistence {
    ...
    private List<SceneConfig> setupMove() {
        ...
        buildupItemTypeCount.put(StaticGameConfigPersistence.BASE_ITEM_TYPE_BULLDOZER, 1);
        ...
        itemTypeCount.put(StaticGameConfigPersistence.BASE_ITEM_TYPE_BULLDOZER, 1);
        ...
        gameTipConfig.setActor(StaticGameConfigPersistence.BASE_ITEM_TYPE_BULLDOZER);
    ...
    private List<SceneConfig> setupTower() {
        ...
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_TOWER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(75, 246))).setNoSpawn(true).setNoRebuild(true));
    ...
    private List<SceneConfig> useInventoryItem() {
        ...
        gameTipConfig.setInventoryItemId(StaticGameConfigPersistence.INVENTORY_ITEM);
    ...
    private List<SceneConfig> buildBase() {
        ...
        startTypeCount.put(StaticGameConfigPersistence.BASE_ITEM_TYPE_BULLDOZER, 1);
        ...
        // Build factory Quest
        Map<Integer, Integer> buildupItemTypeCount = new HashMap<>();
        buildupItemTypeCount.put(StaticGameConfigPersistence.BASE_ITEM_TYPE_FACTORY, 1);
        ...
        buildGameTipConfig.setActor(StaticGameConfigPersistence.BASE_ITEM_TYPE_BULLDOZER);
        buildGameTipConfig.setToCreatedItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_FACTORY);
        ...
        buildupItemTypeCount.put(StaticGameConfigPersistence.BASE_ITEM_TYPE_HARVESTER, 1);
        ...
        factoryGameTipConfig.setActor(StaticGameConfigPersistence.BASE_ITEM_TYPE_FACTORY);
        factoryGameTipConfig.setToCreatedItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_HARVESTER);
    ...
    private List<SceneConfig> killHumanBase() {
        ...
        List<BotEnragementStateConfig> botEnragementStateConfigs = new ArrayList<>();
        List<BotItemConfig> botItems = new ArrayList<>();
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_HARVESTER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(235, 170))).setNoSpawn(true).setNoRebuild(true));
        botEnragementStateConfigs.add(new BotEnragementStateConfig().setName("Normal").setBotItems(botItems));
        botConfigs.add(new BotConfig().setId(ENEMY_BOT).setActionDelay(3000).setBotEnragementStateConfigs(botEnragementStateConfigs).setName("Kenny").setNpc(false));
        // Kill bot command
        List<BotKillHumanCommandConfig> botKillHumanCommandConfigs = new ArrayList<>();
        botKillHumanCommandConfigs.add(new BotKillHumanCommandConfig().setBotId(ENEMY_BOT).setDominanceFactor(2).setAttackerBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER).setSpawnPoint(new PlaceConfig().setPolygon2D(new Rectangle2D(250, 100, 50, 50).toPolygon())));
        // Camera
    ...
    private List<SceneConfig> killEnemyBotBase() {
        ...
        botKillOtherBotCommandConfigss.add(new BotKillOtherBotCommandConfig().setBotId(ENEMY_BOT).setTargetBotId(NPC_BOT_OUTPOST).setDominanceFactor(2).setAttackerBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER).setSpawnPoint(new PlaceConfig().setPolygon2D(new Rectangle2D(250, 100, 50, 50).toPolygon())));
        // Camera
        ViewFieldConfig viewFieldConfig = new ViewFieldConfig().setToPosition(new DecimalPosition(243, 90)).setCameraLocked(false);
    ...
    private List<SceneConfig> killEnemyHarvester() {
        ...
        List<BotItemConfig> botItems = new ArrayList<>();
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_HARVESTER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(235, 170))).setNoSpawn(true).setNoRebuild(true));
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_HARVESTER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(250, 170))).setNoSpawn(true).setNoRebuild(true));
        botEnragementStateConfigs.add(new BotEnragementStateConfig().setName("Normal").setBotItems(botItems));
        botConfigs.add(new BotConfig().setId(ENEMY_BOT).setActionDelay(3000).setBotEnragementStateConfigs(botEnragementStateConfigs).setName("Kenny").setNpc(false));
        List<BotHarvestCommandConfig> botHarvestCommandConfigs = new ArrayList<>();
        botHarvestCommandConfigs.add(new BotHarvestCommandConfig().setBotId(ENEMY_BOT).setResourceItemTypeId(StaticGameConfigPersistence.RESOURCE_ITEM_TYPE).setResourceSelection(new PlaceConfig().setPosition(new DecimalPosition(244, 187))).setHarvesterItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_HARVESTER));
        botHarvestCommandConfigs.add(new BotHarvestCommandConfig().setBotId(ENEMY_BOT).setResourceItemTypeId(StaticGameConfigPersistence.RESOURCE_ITEM_TYPE).setResourceSelection(new PlaceConfig().setPosition(new DecimalPosition(264, 182))).setHarvesterItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_HARVESTER));
        // Camera
        ViewFieldConfig viewFieldConfig = new ViewFieldConfig().setToPosition(new DecimalPosition(243, 90)).setCameraLocked(false);
        // User Spawn
        ...
        killItemTypeCount.put(StaticGameConfigPersistence.BASE_ITEM_TYPE_HARVESTER, 1);
    ...
    private List<SceneConfig> setupPickBox() {
        ...
        boxItemPositions.add(new BoxItemPosition().setBoxItemTypeId(StaticGameConfigPersistence.BOX_ITEM_TYPE).setPosition(new DecimalPosition(110, 80)));
        // Camera
        ViewFieldConfig viewFieldConfig = new ViewFieldConfig().setToPosition(new DecimalPosition(104, 32)).setCameraLocked(false);
    ...
    private List<SceneConfig> findEnemyBase() {
        ...
        attackerBotItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(305, 175))).setNoSpawn(true));
    ...
    private List<SceneConfig> setupAttack() {
        ...
        targetBotItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_BULLDOZER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(100, 80))).setNoSpawn(true).setNoRebuild(true));
        ...
        List<BotEnragementStateConfig> attackerEnragement = new ArrayList<>();
        List<BotItemConfig> attackerBotItems = new ArrayList<>();
        attackerBotItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(90, 80))).setNoSpawn(true).setNoRebuild(true));
        attackerEnragement.add(new BotEnragementStateConfig().setName("Normal").setBotItems(attackerBotItems));
        botConfigs.add(new BotConfig().setId(ENEMY_BOT).setActionDelay(3000).setBotEnragementStateConfigs(attackerEnragement).setName("Kenny").setNpc(false));
        // Attack command
        List<BotAttackCommandConfig> botAttackCommandConfigs = new ArrayList<>();
        botAttackCommandConfigs.add(new BotAttackCommandConfig().setBotId(ENEMY_BOT).setTargetItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_BULLDOZER).setTargetSelection(new PlaceConfig().setPosition(new DecimalPosition(100, 80))).setActorItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER));
        // div
        ViewFieldConfig viewFieldConfig = new ViewFieldConfig().setToPosition(new DecimalPosition(104, 32)).setCameraLocked(false);
    ...
    private List<SceneConfig> demolitionVisualization() {
        ...
        List<BotEnragementStateConfig> botEnragementStateConfigs = new ArrayList<>();
        List<BotItemConfig> botItems = new ArrayList<>();
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_FACTORY).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(270, 260))).setNoSpawn(true).setNoRebuild(true));
        botEnragementStateConfigs.add(new BotEnragementStateConfig().setName("Normal").setBotItems(botItems));
        botConfigs.add(new BotConfig().setId(ENEMY_BOT).setActionDelay(3000).setBotEnragementStateConfigs(botEnragementStateConfigs).setName("Kenny").setNpc(false));
        // Bot attacker
        ...
        botEnragementStateConfigs.add(new BotEnragementStateConfig().setName("Normal").setBotItems(botItems));
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(220, 260))).setNoSpawn(true).setNoRebuild(true));
        ...
        botKillOtherBotCommandConfigs.add(new BotKillOtherBotCommandConfig().setBotId(NPC_BOT_OUTPOST).setTargetBotId(ENEMY_BOT).setDominanceFactor(1).setAttackerBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER).setSpawnPoint(new PlaceConfig().setPolygon2D(Polygon2D.fromRectangle(213, 220, 50, 50))));
    ...
    private void addNpcBot(List<SceneConfig> sceneConfigs) {
        ...
        List<BotEnragementStateConfig> botEnragementStateConfigs = new ArrayList<>();
        List<BotItemConfig> botItems = new ArrayList<>();
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_HARVESTER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(223, 130))).setAngle(Math.toRadians(110)).setNoSpawn(true).setNoRebuild(true));
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_FACTORY).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(220, 109))).setNoSpawn(true).setNoRebuild(true));
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_FACTORY).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(213, 92))).setNoSpawn(true).setNoRebuild(true));
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_BULLDOZER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(207, 111))).setAngle(Math.toRadians(30)).setNoSpawn(true).setNoRebuild(true));
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(201, 94))).setAngle(Math.toRadians(175)).setNoSpawn(true).setNoRebuild(true));
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_HARVESTER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(201, 88))).setAngle(Math.toRadians(310)).setNoSpawn(true).setNoRebuild(true));
        botEnragementStateConfigs.add(new BotEnragementStateConfig().setName("Normal").setBotItems(botItems));
        ...
        List<BotHarvestCommandConfig> botHarvestCommandConfigs = new ArrayList<>();
        botHarvestCommandConfigs.add(new BotHarvestCommandConfig().setBotId(NPC_BOT_OUTPOST).setResourceItemTypeId(StaticGameConfigPersistence.RESOURCE_ITEM_TYPE).setResourceSelection(new PlaceConfig().setPosition(new DecimalPosition(212, 144))).setHarvesterItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_HARVESTER));
    ...
    private void addEnemyBot(List<SceneConfig> sceneConfigs) {
        ...
        List<BotEnragementStateConfig> botEnragementStateConfigs = new ArrayList<>();
        List<BotItemConfig> botItems = new ArrayList<>();
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_TOWER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(190, 242))).setNoSpawn(true).setNoRebuild(true));
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_FACTORY).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(248, 283))).setNoSpawn(true).setNoRebuild(true));
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_FACTORY).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(277, 296))).setNoSpawn(true).setNoRebuild(true));
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_FACTORY).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(299, 261))).setNoSpawn(true).setNoRebuild(true));
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_BULLDOZER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(240, 255))).setAngle(Math.toRadians(100)).setNoSpawn(true).setNoRebuild(true));
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_BULLDOZER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(277, 252))).setAngle(Math.toRadians(200)).setNoSpawn(true).setNoRebuild(true));
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_BULLDOZER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(260, 227))).setAngle(Math.toRadians(333)).setNoSpawn(true).setNoRebuild(true));
        // Attackers 4 harvester
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(230, 187))).setAngle(Math.toRadians(260)).setNoSpawn(true).setNoRebuild(true));
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(234, 187))).setAngle(Math.toRadians(260)).setNoSpawn(true).setNoRebuild(true));
        // Harvester to harvest after attack
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_HARVESTER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(253, 200))).setAngle(Math.toRadians(240)).setNoSpawn(true).setNoRebuild(true));
    ...
    private void addBotSpawnScene(List<SceneConfig> sceneConfigs) {
        ...
        List<BotEnragementStateConfig> botEnragementStateConfigs = new ArrayList<>();
        List<BotItemConfig> botItems = new ArrayList<>();
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_BULLDOZER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(116, 100))).setNoRebuild(true));
        botEnragementStateConfigs.add(new BotEnragementStateConfig().setName("Normal").setBotItems(botItems));
    ...
    private void addUserSpawnScene(List<SceneConfig> sceneConfigs) {
        ...
        gameTipConfig.setToCreatedItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_BULLDOZER);
    ...
    private void addBotMoveScene(List<SceneConfig> sceneConfigs) {
        ...
        botMoveCommandConfigs.add(new BotMoveCommandConfig().setBotId(NPC_BOT_INSTRUCTOR).setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_BULLDOZER).setTargetPosition(new DecimalPosition(188, 90)));
    ...
    private void addNpcHarvestAttack(List<SceneConfig> sceneConfigs) {
        ...
        List<BotAttackCommandConfig> botAttackCommandConfigs = new ArrayList<>();
        botAttackCommandConfigs.add(new BotAttackCommandConfig().setBotId(ENEMY_BOT).setTargetItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_HARVESTER).setActorItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER).setTargetSelection(new PlaceConfig().setPolygon2D(Polygon2D.fromRectangle(190, 124, 40, 40))));
        botAttackCommandConfigs.add(new BotAttackCommandConfig().setBotId(ENEMY_BOT).setTargetItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_HARVESTER).setActorItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER).setTargetSelection(new PlaceConfig().setPolygon2D(Polygon2D.fromRectangle(190, 124, 40, 40))));
    ...
    private void addFindEnemyBase(List<SceneConfig> sceneConfigs) {
        ...
        List<BotHarvestCommandConfig> botHarvestCommandConfigs = new ArrayList<>();
        botHarvestCommandConfigs.add(new BotHarvestCommandConfig().setBotId(ENEMY_BOT).setResourceItemTypeId(StaticGameConfigPersistence.RESOURCE_ITEM_TYPE).setResourceSelection(new PlaceConfig().setPosition(new DecimalPosition(212, 144))).setHarvesterItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_HARVESTER));
        // Tip
        GameTipConfig gameTipConfig = new GameTipConfig();
        gameTipConfig.setTip(GameTipConfig.Tip.SCROLL);
    ...
    private void addPickBoxTask(List<SceneConfig> sceneConfigs) {
        // Drop box
        List<BoxItemPosition> boxItemPositions = new ArrayList<>();
        boxItemPositions.add(new BoxItemPosition().setBoxItemTypeId(StaticGameConfigPersistence.BOX_ITEM_TYPE).setPosition(new DecimalPosition(188, 116)));
        // Pick box quest
        ...
        gameTipConfig.setActor(StaticGameConfigPersistence.BASE_ITEM_TYPE_BULLDOZER);
        gameTipConfig.setToGrabItemTypeId(StaticGameConfigPersistence.BOX_ITEM_TYPE);
    ...
    private void addBoxSpawnTask(List<SceneConfig> sceneConfigs) {
        ...
        // Move attackers away
        List<BotMoveCommandConfig> botMoveCommandConfigs = new ArrayList<>();
        botMoveCommandConfigs.add(new BotMoveCommandConfig().setBotId(ENEMY_BOT).setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER).setTargetPosition(new DecimalPosition(255, 244)));
        botMoveCommandConfigs.add(new BotMoveCommandConfig().setBotId(ENEMY_BOT).setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER).setTargetPosition(new DecimalPosition(257, 246)));
        // Tip
        GameTipConfig gameTipConfig = new GameTipConfig();
        gameTipConfig.setTip(GameTipConfig.Tip.SPAN_INVENTORY_ITEM);
        gameTipConfig.setInventoryItemId(StaticGameConfigPersistence.INVENTORY_ITEM);
    ...
    private void addAttackTask(List<SceneConfig> sceneConfigs) {
        ...
        attackItemTypeCount.put(StaticGameConfigPersistence.BASE_ITEM_TYPE_HARVESTER, 1);
        ...
        gameTipConfig.setActor(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER);
    ...
    private void addEnemyKillTask(List<SceneConfig> sceneConfigs) {
        // Kill bot command
        List<BotKillOtherBotCommandConfig> botKillOtherBotCommandConfigs = new ArrayList<>();
        botKillOtherBotCommandConfigs.add(new BotKillOtherBotCommandConfig().setBotId(ENEMY_BOT).setTargetBotId(NPC_BOT_OUTPOST).setDominanceFactor(1).setAttackerBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER).setSpawnPoint(new PlaceConfig().setPolygon2D(Polygon2D.fromRectangle(212, 162, 51, 87))));
        // Kill human command
        List<BotKillHumanCommandConfig> botKillHumanCommandConfigs = new ArrayList<>();
        botKillHumanCommandConfigs.add(new BotKillHumanCommandConfig().setBotId(ENEMY_BOT).setDominanceFactor(2).setAttackerBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER).setSpawnPoint(new PlaceConfig().setPolygon2D(Polygon2D.fromRectangle(213, 209, 80, 70))));
    ...
    private void addNpcEscapeTask(List<SceneConfig> sceneConfigs) {
        List<BotMoveCommandConfig> botMoveCommandConfigs = new ArrayList<>();
        botMoveCommandConfigs.add(new BotMoveCommandConfig().setBotId(NPC_BOT_INSTRUCTOR).setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_BULLDOZER).setTargetPosition(new DecimalPosition(48, 110)));
    ...
    private void addUserSpawnScene2(List<SceneConfig> sceneConfigs) {
        ...
        List<BotEnragementStateConfig> botEnragementStateConfigs = new ArrayList<>();
        List<BotItemConfig> botItems = new ArrayList<>();
        botItems.add(new BotItemConfig().setBaseItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER).setCount(1).setCreateDirectly(true).setPlace(new PlaceConfig().setPosition(new DecimalPosition(145, 260))).setNoSpawn(true).setNoRebuild(true));
        botEnragementStateConfigs.add(new BotEnragementStateConfig().setName("Normal").setBotItems(botItems));
    ...
    private void addBuildFactoryTask(List<SceneConfig> sceneConfigs) {
        ...
        gameTipConfig.setActor(StaticGameConfigPersistence.BASE_ITEM_TYPE_BULLDOZER);
        gameTipConfig.setToCreatedItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_FACTORY);
    ...
    private void addFactorizeHarvesterTask(List<SceneConfig> sceneConfigs) {
        ...
        gameTipConfig.setActor(StaticGameConfigPersistence.BASE_ITEM_TYPE_FACTORY);
        gameTipConfig.setToCreatedItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_HARVESTER);
    ...
    private void addHarvestTask(List<SceneConfig> sceneConfigs) {
        ...
        gameTipConfig.setActor(StaticGameConfigPersistence.BASE_ITEM_TYPE_HARVESTER);
        gameTipConfig.setToGrabItemTypeId(StaticGameConfigPersistence.RESOURCE_ITEM_TYPE);
    ...
    private void addBuildViperTask(List<SceneConfig> sceneConfigs) {
        // Build viper
        Map<Integer, Integer> buildupItemTypeCount = new HashMap<>();
        buildupItemTypeCount.put(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER, 1);
        ConditionConfig conditionConfig = new ConditionConfig().setConditionTrigger(ConditionTrigger.SYNC_ITEM_CREATED).setComparisonConfig(new ComparisonConfig().setTypeCount(buildupItemTypeCount));
        GameTipConfig gameTipConfig = new GameTipConfig();
        gameTipConfig.setTip(GameTipConfig.Tip.FABRICATE);
        gameTipConfig.setActor(StaticGameConfigPersistence.BASE_ITEM_TYPE_FACTORY);
        gameTipConfig.setToCreatedItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER);
    ...
    private void addNpcAttackTowerCommand(List<SceneConfig> sceneConfigs) {
        // Attack command
        List<BotAttackCommandConfig> botAttackCommandConfigs = new ArrayList<>();
        botAttackCommandConfigs.add(new BotAttackCommandConfig().setBotId(NPC_BOT_OUTPOST_2).setTargetItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_TOWER).setTargetSelection(new PlaceConfig().setPosition(new DecimalPosition(190, 242))).setActorItemTypeId(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER));
    ...
    private void addBuildViperTask2(List<SceneConfig> sceneConfigs) {
        // Build viper
        Map<Integer, Integer> buildupItemTypeCount = new HashMap<>();
        buildupItemTypeCount.put(StaticGameConfigPersistence.BASE_ITEM_TYPE_ATTACKER, 2);
        ConditionConfig conditionConfig = new ConditionConfig().setConditionTrigger(ConditionTrigger.SYNC_ITEM_CREATED).setComparisonConfig(new ComparisonConfig().setTypeCount(buildupItemTypeCount));
        // Tip
        GameTipConfig gameTipConfig = new GameTipConfig();
        gameTipConfig.setTip(GameTipConfig.Tip.FABRICATE);
    ...
    private void addKillTower(List<SceneConfig> sceneConfigs) {
        Map<Integer, Integer> buildupItemTypeCount = new HashMap<>();
        buildupItemTypeCount.put(StaticGameConfigPersistence.BASE_ITEM_TYPE_TOWER, 1);

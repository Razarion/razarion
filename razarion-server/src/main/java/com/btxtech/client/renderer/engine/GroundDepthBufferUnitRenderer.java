 ...
 */
@Dependent
public class GroundDepthBufferUnitRenderer extends AbstractWebGlUnitRenderer {
    // private Logger logger = Logger.getLogger(GroundDepthBufferUnitRenderer.class.getName());

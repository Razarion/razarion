 ...
 */
@Dependent
public class TerrainObjectUnitRenderer extends AbstractWebGlUnitRenderer {
    private Logger logger = Logger.getLogger(TerrainObjectUnitRenderer.class.getName());
    @Inject
    ...
    protected void modelDraw(ModelMatrices modelMatrices) {
        ...
        uniformMatrix4fv(U_MODEL_NORM_MATRIX, modelMatrices.getNorm());

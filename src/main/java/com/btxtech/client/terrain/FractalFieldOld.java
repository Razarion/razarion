 ...
 */
@Deprecated
public class FractalFieldOld {
    private double[][] terrain;
    private int divisions;
    private Random rng;

    public FractalFieldOld(int verticesPerEdge, double roughness) {
    ...
    public static FractalFieldOld createSaveFractalField(int size1, int size2, double max, double min, double roughness) {
        FractalFieldOld fractalFieldOld = new FractalFieldOld(nearestPossibleNumber(size1, size2), roughness);
        fractalFieldOld.normalize(max, min);
        return fractalFieldOld;
    }
}

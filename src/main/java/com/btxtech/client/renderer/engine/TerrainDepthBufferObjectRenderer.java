 ...
 */
@Dependent
public class TerrainDepthBufferObjectRenderer extends AbstractRenderer {
    ...
    @PostConstruct
    public void init() {
        createProgram(Shaders.INSTANCE.terrainObjectDepthBufferVertexShader(), Shaders.INSTANCE.terrainObjectDepthBufferFragmentShader());
